...
/** 
 * DAO for table "USER_ACTIVITY".
*/
public class UserActivityDao extends AbstractDao<UserActivity, Long> {

    public static final String TABLENAME = "USER_ACTIVITY";

    /**
     * Properties of entity UserActivity.<br/>
    ...
    */
    ...
    public UserActivityDao(DaoConfig config) {
        super(config);
    }
    
    public UserActivityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER_ACTIVITY\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"USER_ACTIVITY\"";
        db.execSQL(sql);
    }
